...
This is Project #7 of my Grow with Google Front-end Web Development Scholarship Program. We are asked to use React to develop a single-page application featuring a map of my neighborhood or a neighborhood I would like to visit. I chose Washington, D.C., my hometown, to be the neighborhood of my choice. In addition to the course materials, I went through a React course by Mosh (https://www.youtube.com/watch?v=Ke90Tje7VS0) and referenced some of the materials in the resources sheet curated by fellow GwG scholars (https://www.diigo.com/outliner/fkkuvb/Udacity-Neighborhood-Map-Project-(project-%237)?key=25wgqnwals).

# Instructions

You'll be running this app on your local device. After you download the zip file and save it to a local location, open the terminal from the same location, and run the following:

1. npm install: install all project dependencies
2. npm start: start the development server, which will open your default browser and you'll be able to view the app

# Dependencies

All dependencies are included in the .json file.

# Use of File

You can search places that sell cookies in downtown Washington, D.C. You'll see a list of 10 cookie places as you open the file. Click on the list of places on the sidebar and you'll see it showing as a marker on the map, including picture of the place.
...
## Table of Contents (Directly from Create React App(https://github.com/facebook/create-react-app))
